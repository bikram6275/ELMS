                ...
                <div class="col-md-12" id="listing">
                    <div class="card card-default">
                        <div class="card-header with-border">
                            ...
                            <a href="{{url('/enumeratorassign/')}}" class="pull-right cardTopButton" id="add"
                               data-toggle="tooltip"
                               title="Add New"><i class="fa fa-plus-circle fa-2x" style="font-size: 20px;"></i></a>

                            <a href="{{url('/enumeratorassign')}}" class="pull-right cardTopButton"
                               data-toggle="tooltip"
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open(['method'=>'get',route('enumeratorassign.index'),'enctype'=>'multipart/form-data','file'=>true]) !!}

                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('pradesh_id'))?'has-error':'' }}">
                                        <label>Pradesh: </label>
                                        {{Form::select('pradesh_id',$pradeshes->pluck('pradesh_name','id'),Request::get('pradesh_id'),['class'=>'form-control select2','id'=>'pradesh_id','name'=>'pradesh_id','placeholder'=>
                                        'Select Pradesh'])}}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('district_id'))?'has-error':'' }}">
                                        ...
                                        {{Form::select('district_id',$districts->pluck('english_name','id'),Request::get('district_id'),['class'=>'form-control select2','id'=>'district_id','name'=>'district_id','placeholder'=>
                                        'Select District'])}}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('muni_id'))?'has-error':'' }}">
                                        ...
                                        {{Form::select('muni_id',$municipalities->pluck('muni_name','id'),Request::get('muni_id'),['class'=>'form-control select2','id'=>'municipality_id','placeholder'=>
                                        'Select Municipality'])}}
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('enumerator_id'))?'has-error':'' }}">
                                        ...
                                        {{Form::select('enumerator_id',$emitters->pluck('name','id'),Request::get('enumerator_id'),['class'=>'form-control select2','id'=>'enumerator_id','name'=>'enumerator_id','placeholder'=>
                                        'Select Enumerator'])}}
...
{{--                                                {{dd($organization)}}--}}
                                                ...
                                                <tr id="sid{{$organization->id}}">
                                                    ...
                                                    <td>
                                                        <a href="{{url('enumeratorassign/delete/'.$organization->emu_id )}}"
...
{{--                                        <input type="hidden" name="emu_id" value="{{$organization->emu_id}}">--}}
{{--                                        <input type="hidden" name="sur_id" value="{{$organization->survey_id}}">--}}
                                            @endforeach
                                            </tbody>
                                            <?php $i++; ?>
                                        </table>
