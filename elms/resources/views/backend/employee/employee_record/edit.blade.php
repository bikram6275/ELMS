...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            {!! Form::model($edits, ['method'=>'put','route'=>['employeeRecord.update',$edits->id],'enctype'=>'multipart/form-data','file'=>true]) !!}
                ...
                <div class="col-md-12" id="listing">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {{ ($errors->has('education_type_id'))?'has-error':'' }}">
                                        ...
                                        <div class="input-group mb-3">
                                            {{Form::select('education_type_id',$eduTypes->pluck('name','id'),$empEdus->education_type_id,['class'=>'form-control
                                         select2','id'=>'education_type_id','name'=>'education_type_id','placeholder'=>
                                         'Select Education Type'])}}
                                            {!! $errors->first('education_type_id', '<span
                                                class="text-danger">:message</span>')
                                            !!}
                                        </div>
                                        {!! $errors->first('phone_no', '<span class="text-danger">:message</span>')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group {{ ($errors->has('education_level_id'))?'has-error':'' }}">
                                        ...
                                        <div class="input-group mb-3">
                                            {{Form::select('education_level_id',$eduLevels->pluck('level','id'),$empEdus->education_level_id,['class'=>'form-control
                            ...
                            @if($edits->marital_status=='married')
                                <div class="row" id="maritial_status">
                                    <div class="col-md-6">
                                        <div class="form-group {{ ($errors->has('spouse_name'))?'has-error':'' }}">
                                            <label>Spouse Name: </label>
                                            <div class="input-group mb-3">
                                                {!!
                                                Form::text('spouse_name',null,['class'=>'form-control','id'=>'spouse_name',
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{ ($errors->has('no_of_children'))?'has-error':'' }}">
                                            ...
                                            <div class="input-group mb-3">
                                                {!!
                                                Form::number('no_of_children',null,['class'=>'form-control','id'=>'no_of_children',
                        ...
                        @else
                            <div class="row" style="display: none" id="maritial">
                                <div class="col-md-6">
                                    <div class="form-group {{ ($errors->has('spouse_name'))?'has-error':'' }}">
                                        <label>Spouse Name: </label>
                                        <div class="input-group mb-3">
            ...
            <div class="card-header with-border">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div
                                class="form-group {{ ($errors->has('permanent_district_id'))?'has-error':'' }}">
            ...
            <div class="card-header with-border">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group {{ ($errors->has('employee_type_id'))?'has-error':'' }}">
                                ...
                                {!! $errors->first('organization_id', '<span class="text-danger">:message</span>')
                                !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div
                                class="form-group {{ ($errors->has('immediate_promoted_date'))?'has-error':'' }}">
                    ...
                    <div class="row ">
                        <div class="col-md-4">
                            <div
                                class="form-group {{ ($errors->has('working_hour_per_week'))?'has-error':'' }}">
                                <label>Per Week: </label>
                                <div class="input-group mb-3">
                                    {!!
                                    Form::text('working_hour_per_week',null,['class'=>'form-control',
                                    'placeholder'=>'working_hour_per_week']) !!}
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    'placeholder'=>'working_hour_per_days_in_month']) !!}
                                </div>
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" name="id[]"
                                                       value={{$orgRec->id}}
                                                           type="hidden">
                                                {!!
                                            Form::text('organization_name[]',$orgRec->organization_name,['class'=>'form-control',
                                            'placeholder'=>'Organization Name']) !!}
                                            </div>
                                        </td>
                                        <td width="400px">
                                            <div class="form-group"> {!!
                                            Form::text('last_position[]',$orgRec->last_position,['class'=>'form-control',
                                            'placeholder'=>'Last Position']) !!}
                                            </div>
                                        </td>
                                        <td width="400px">
                                            <div class="form-group"> {!!
                                            Form::text('total_experience_year[]',$orgRec->total_experience_year,['class'=>'form-control',
                                            'placeholder'=>'Year']) !!}
                                            </div>
                                        </td>
                                        <td width="400px">
                                            <div class="form-group"> {!!
                                            Form::text('total_experience_month[]',$orgRec->total_experience_month,['class'=>'form-control',
                                            'placeholder'=>'Month']) !!}
                                            </div>
                                        </td>
                                        <td width="200px">
                                            <a href='#' class='btn btn-small btn-danger remove-selected remove_employee',onclick="reloadPage();"
                                               id="remove-selected" data-id="{{$orgRec->id}}"><i
                        ...
                        <div class="row">
                            <table class="table table-bordered" id="dynamicTable">
                                ...
                                <tr>
                                    ...
                                    <td width="200px">
                                        <a href='#' class='btn btn-small btn-danger remove-selected'><i
                                                class="fa fa-remove"></i></a>
                                        <a href='#'>
                                            <button class="btn btn-small btn-info add_employee ml-2"><i
                                                    class="fa fa-plus"></i></button>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            var edits = {!! json_encode(isset($edits) ? $edits : null) !!};
            var permanent_pradesh_id = edits['permanent_pradesh_id'];
            var permanent_district_id = edits['permanent_district_id'];
            var permanent_municipality_id = edits['permanent_muni_id'];
            ...
            function getDisByPradesh() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $.each(data, function (key, value) {
                            flag = (permanent_district_id == value.id) ? "selected='selected'" : "";
                            district_option += `<option value="${value.id}" ${flag}> ${value.nepali_name}</option>`;
                        });
            ...
            function getMuniByDis() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $.each(data, function (key, value) {
                            var is_selected = value.id == permanent_municipality_id ? 'selected="selected"' : "";
                            muni_option += `<option value="${value.id}" ${is_selected}>${value.muni_name}</option>`;
                        });
            ...
            if (permanent_pradesh_id > 0) {

                getDisByPradesh();
            }
            if (permanent_district_id > 0) {
                getMuniByDis();
            }
        });
    </script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".remove-selected").click(function () {
                ...
                $.ajax(
                    {
                        url: "{{url('/orgs/delete/selected/')}}/" + id,
                        type: 'DELETE',
                        dataType: "json",
                        data: {
                            "id": id,
