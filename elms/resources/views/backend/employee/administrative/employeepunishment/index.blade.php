                    ...
                    <div class="card-header with-border">
                        <div class="card card-default">
                            <div class="card-header with-border">
                                ...
                                <a href="{{url('/employee/punishment/create')}}" class="pull-right cardTopButton" id="add" data-toggle="tooltip"
                                   title="Add New"><i class="fa fa-plus-circle fa-2x" style="font-size:20px;"></i></a>

                                <a href="{{url('/employee/punishment')}}" class="pull-right cardTopButton" data-toggle="tooltip"
                        ...
                        <table id="example1" class="table table-striped table-bordered table-hover table-responsive">
                            ...
                            @foreach($employee_punishments as $key=>$employee_punishment)
                                <tr>
                                    ...
                                    <td>{{$employee_punishment->year}}</td>

                                    </td>
                                        <td class="text-right row" style="margin-right: 0px;">

                                            <a href="{{url('/employee/punishment/'.$employee_punishment->id .'/edit')}}"
                                               class="text-info btn btn-xs btn-default">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </a>

                                            {!! Form::open(['method' => 'DELETE', 'route'=>['punishment.destroy',
                                                    $employee_punishment->id],'class'=> 'inline']) !!}
                                            <button type="submit"
