...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            {!!
            Form::open(['method'=>'post','url'=>'/orgs/employee/responsibility','enctype'=>'multipart/form-data','file'=>true])
            !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ ($errors->has('date_of_birth'))?'has-error':'' }}">
                                        ...
                                        <div class="input-group mb-3">
                                            {{Form::select('name',$responsibility->pluck('name','id'),Request::get('id'),['class'=>'form-control
                                         select2','id'=>'responsibility_type','name'=>'responsibility_type','placeholder'=>
                                         'Responsibility'])}}
                                        </div>
                                        {!! $errors->first('responsibility_type', '<span class="text-danger">:message</span>') !!}
                                    </div>
