            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header with-border">
                        <a href="{{url('/orgs/dashboard')}}" class="pull-right" data-toggle="tooltip" title="Go Back"><i
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-primary">
                                    <div class="card-body   ">
                                        <a data-toggle="modal" data-target="#myModal ">
                                            @if($user->org_image!=null)
                                                <img class="profile-user-img img-responsive img-circle"
                                                     src="{{asset('/storage/uploads/organization/images/organizationPic/'.$user->org_image)}}"
                                        ...
                                        <h3 class="profile-username text-center">{{$user->org_name}}</h3>
...
{{--                                        <p class="text-muted text-center">{{$user->designation->designation_name}}</p>--}}
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <strong><i class="fa fa-envelope margin-r-5"></i> Website</strong>
                                        <p class="text-muted">
                                            <a href="">{{$user->website}}</a>
                                        </p>
                                        <hr>
                                        <strong><i class="fa fa-envelope margin-r-5"></i> Established Date</strong>
                                        <p class="text-muted">
                                            {{$user->establish_date}}
                                        </p>
                            ...
                            <div class="col-md-9">
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " id="custom-content-above-home-tab" data-toggle="pill" href="#custom-content-above-home" role="tab" aria-controls="custom-content-above-home" aria-selected="true">Setting</a>
                                        </li>
                                    ...
                                    <div class="tab-content" id="custom-content-above-tabContent">
                                        ...
                                        <div class="tab-pane fade show " id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab" style="padding-top: 20px;">
                                            ...
                                            <form id="myform" class="form-horizontal" action="{{url('/orgs/profile/password')}}" method="post">
...
@section('js')
    ...
    <script>
        ...
        else
        {
            ...
            {
                var profileTab = '#custom-content-above-details';
