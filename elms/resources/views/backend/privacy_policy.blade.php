...
<body>
    <div class="container">
        ...
        <p class="para">The project Establishing an Employer led Labor Market Secretariat – ELMS project, was
            launched in Kathmandu on 23 November 2020 among a ceremony in presence of high level dignitaries from donor,
            implementing partners and FNCCI.

            ELMS: Employer led Labor Market Secretariat is a Labour Market Information (demand side) development
            program, that will collect, compile and analysis the Labour Market Information of FNCCI, CNI, FCAN, FNCSI
            and HAN members, for the use of TEVT sector. The project will work to develop a demand side labor market
            data system. Through the project, Occupational profile and labor market information system will be
            developed. The project will be implemented in the fields of agriculture, construction and tourism sector.

            Employer led Labor Market Secretariat develop the ELMS app as a Free app. This SERVICE is provided by
            Employer led Labor Market Secretariat at no cost and is intended for use as is:
            ...
            accessible at ELMS unless otherwise defined in this Privacy Policy.
        </p>
        <h3>Information Collection and Use</h3>
        <p class="para">
            For a better experience, while using our Service, we may require you to provide us with certain personally
            identifiable information, including but not limited to Employer led Labor Market Secretariat. The
            ...
            <a href="https://www.google.com/policies/privacy/">
                <li class="para">Google Play Services</li>
            </a>
        </p>
        <h3>Log Data</h3>
        <p class="para">
            ...
            information such
            as your device Internet Protocol (“IP”) address, device name, operating system version, the configuration of
            the app when utilizing our Service,
        ...
        <p class="para">This Service may contain links to other sites. If you click on a third-party link, you
            will be directed to
            that
        ...
        <p class="para">We may update our Privacy Policy from time to time. Thus, you are advised to review
            this page periodically for
            any changes. We will notify you of any changes by posting the new Privacy Policy on this page.
            This policy is effective as of 2022-03-22</p>

        <h3>Contact Us</h3>
        <p class="para">If you have any questions or suggestions about our Privacy Policy, do not hesitate to
            contact us at
            elmsvacancy@gmail.com.
        </p>
    </div>
</body>
