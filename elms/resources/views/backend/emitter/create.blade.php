                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add Enumerator</li>
                            <li class="breadcrumb-item active">Add Enumerator</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12" id="listing">
                    <div class="card card-default">
                        <div class="card-header with-border">
                            <h3 class="card-title">Enumerator Details</h3>
                        ...
                        <div class="card-body">
                            {!! Form::open(['method'=>'post','url'=>'emitter','enctype'=>'multipart/form-data','file'=>true]) !!}
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group {{ ($errors->has('name'))?'has-error':'' }}">
                                        <label>Enumerator Name: </label><label class="text-danger">*</label>
                                        <div class="input-group mb-3">
                                            {!! Form::text('name',null,['class'=>'form-control','placeholder'=>'Enumerator Name']) !!}
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ ($errors->has('supervisor_id'))?'has-error':'' }}">
                                    ...
                                    {{Form::select('supervisor_id',$supervisors,Request::get('id'),['class'=>'form-control select2','id'=>'supervisor_id','name'=>'supervisor_id','placeholder'=>
                                    'Select Supervisor'])}}
                            ...
                            <div class="card card-default">
                                <div class="card-header with-border">
                                    <h3 class="card-title"><strong>Enumerator Login  Information :</strong></h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
