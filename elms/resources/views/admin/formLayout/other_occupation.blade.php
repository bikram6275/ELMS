<table class="table table-bordered" id="occupationTable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{!! Form::select("occu[$key][occupation_id]", $occupations->pluck('occupation_name', 'id'), $value['occupation_id'], ['class' => 'form-control  select2 occ-required', 'style' => 'width:100%;', 'id' => "occupation_$key", 'placeholder' => 'Select Occupation']) !!}
    ...
    @endforeach
        ...
        @else
            <tr>
                <td>{!! Form::select('occu[0][occupation_id]', $occupations->pluck('occupation_name', 'id'), null, ['class' => 'form-control  select2 occ-required ', 'style' => 'width:100%;', 'id' => 'occupation_0', 'placeholder' => 'Select Occupation']) !!}
    ...
    <script>
        ...
        $('#add1').click(function() {
            ...
            $("#occupationTable").append(
                ` <tr>
            <td>{!! Form::select('occu[${row_count}][occupation_id]', $occupations->pluck('occupation_name', 'id'), null, ['class' => 'form-control  select2 occ-required', 'id' => 'occupation_0', 'placeholder' => 'Select Occupation', 'style' => 'width:100%;']) !!}</td>
