    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ URL::previous() }}">Assigned Organization</a></li>
        ...
        <section class="content">
            ...
            <div class="card card-default bg-light">
                ...
                <div class="card-body ">
                    {!! Form::open(['method' => 'post', 'url' => '/answer', 'autocomplete' => 'off', 'role' => 'form']) !!}
                    ...
                    <div class="row">
                        ...
                        @php
                            $qsn_id = Request::segment(5);

                        @endphp


                        <div class="all-steps " id="all-steps">
                            <a class="step {{ $first_page == true ? 'active' : '' }}"
                                href="{{ url('survey/orgs/' . $pivot_id) }}">1</a>

                            @foreach ($questions as $key => $qsn)

                                <a class="step {{ isset($qsn->is_answer) && $qsn->is_answer ?'visited':'' }} {{ $qsn_id == $qsn->id ? 'active' : '' }}"
                                    href="{{ url('survey/orgs/question/' . $pivot_id . '/' . $qsn->id) }}">{{ $qsn->qsn_number }}</a>
                            @endforeach
                        </div>
                        @if ($first_page == true)
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12" style="text-align: left">
                                        <table class="table table-border table-striped table-hover">
                                            <tr>
                                             ...
                                             <tr>
                                                <th> c. VAT/PAN number: </th>
                                                <td>{{ $org_details->pan_number }}</td>
                                            </tr>
                                            <tr>
                                                <th> d. Registration/License number:  </th>
                                                <td>{{ $org_details->licensce_no }}</td>
                                            </tr>
                                    ...
                                    <div class="col-md-12 mx-1" style="text-align: left">
                                        ...
                                        <table class="table table-border table-striped table-hover ml-3">
                                            ...
                                            <tr>
                                                <th> Phone</th>
                                                <td> {{ $org_details->phone_no }}</td>
                                            </tr>
                                            <tr>
                                                <th> Fax</th>
                                                <td> {{ $org_details->fax }}</td>
                                            </tr>
                                            <tr>
                                                <th> Email</th>
                                                <td> {{ $org_details->email }}</td>
                                            </tr>
                                            <tr>
                                                <th> Website</th>
                                                <td> {{ $org_details->website }}</td>
                                            </tr>
                                    ...
                                    <div class="col-md-12" style="text-align: left">
                                        <table class="table table-border table-striped table-hover">
                                            <tr>
                                                <th>f. Date of Establishment</th>
                                                <td>{{ $org_details->establish_date }}</td>
                                            </tr>
                        ...
                        @endif
                        @if ($first_page == false)
                            <div class="card mx-auto  mt-3 {{ $recent_questions['qsn_number']=='18' || $recent_questions['qsn_number']=='6.b' || $recent_questions['qsn_number']=='6.a' || $recent_questions['qsn_number']=='5'?'col-md-12':'col-md-10' }}">
                                <div class="card-body">

                                    @include('admin.answer.question')
                                </div>
                            </div>
                        @endif
                ...
                <div class="card-footer mt-4 ">
                    <div class="col-md-12">
                            <?php
                                ...
                                if($qsn_id=='14'  || $qsn_id=='7' ||$qsn_id=='38'){
                            ...
                            ?>
                            <button type="submit" class="btn  pull-right mx-3 {{ $next==0?'btn-danger':'btn-success' }}" id="submitBtn">{{ $next==0?'Submit':'Next' }} </button>
                            <a href="{{ url('survey/orgs/question/' . $pivot_id . '/' . $previous_id) }}"
