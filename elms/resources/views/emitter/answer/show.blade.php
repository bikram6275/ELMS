...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                                            ...
                                            <p class="" style="text-indent :2em;">-
                                                ...
                                                @if ($question->qsn_number == 10 && $question->answer[0]->other_answer)
                                                    <div style="text-indent :2em;">
                                                        <h6> <span class="font-weight-bold"> Other Value : </span>{{ $question->answer[0]->other_answer }}</h6>
                                                    </div>
                                                @endif
                                            </p>
                                        @endif
                                                    ...
                                                    <tbody class="text-center">
                                                        ...
                                                        @foreach ($business_plans as $val)
                                                            <tr>
                                                                ...
                                                                <td>{{ $val->other_occupation_value   }}</td>
                                                                <td>{{ $val->level }}</td>
                                                        ...
                                                        @if ($othter_occupationAnswer != null && count($othter_occupationAnswer) > 0)
                                                            @foreach ($othter_occupationAnswer as $key => $value)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $value->other_value?$value->other_value:'-' }}</td>
                                        ...
                                        @if (count($technicalAnswer) > 0)
                                            @foreach ($technicalAnswer as $key => $value)
                                                <tr>
                                                    ...
                                                    <td>{{ $value->occupation->occupation_name == 'Others' ? $value->other_occupation_value : '-' }}</td>
                        ...
                        @elseif($question->qsn_number == '13')
                            <table class="table table-bordered">
                                <thead class="text-center">
                                    <tr>
                                        <th>Aspects</th>
                                        <th>Formally Trained</th>
                                        <th>Formally Untrained (Experienced)</th>
                                    </tr>
                                <tbody>
            ...
            @if (isset($is_supervisor) && $is_supervisor && isset($is_approved) && !$is_approved)
                <div class="row justify-content-center ">
                    <a class="btn btn-primary mb-2" href="{{ route('survey.approve', request()->id) }}"> Approve</a>
                </div>
            @endif
            @isset($feedbacks)
                <hr>
