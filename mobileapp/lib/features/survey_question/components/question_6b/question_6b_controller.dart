...
class Question6bController extends GetxController {
  ...
  createControllerForFields() {
    ...
    for (var element in list) {
      TextEditingController q6bWorkingNumber = TextEditingController();
      TextEditingController q6bRequiredNumber = TextEditingController();
      TextEditingController q6bEstimateRequired2Year = TextEditingController();
      TextEditingController q6bEstimateRequired5Year = TextEditingController();
