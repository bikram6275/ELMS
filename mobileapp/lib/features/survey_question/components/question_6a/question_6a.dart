                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            CustomButton(
                                                ...
                                                onPressed: () {
                                                  _question6aController
                                                      .assignValuesFromObjectToVariables(
                                                          _question6aController
                                                                  .q6aAnswersList[
                                                              index]);
                                                  Get.toNamed(
                ...
                if (_question6aController.checkVariables() &&
                  ...
                  _question6aController.q6aAnswersList.add(
                    Question6AAnswerModel(
                        ...
                        gender: _question6aController.getEnumOfValues(
                            _question6aController.gender.value),
                        workingTime: _question6aController.getEnumOfValues(
                            _question6aController.workingHours.value),
                        workNature: _question6aController.getEnumOfValues(
                            _question6aController.nature.value),
                        training: _question6aController.getEnumOfValues(
                            _question6aController.training.value),
