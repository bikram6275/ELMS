      ...
      children: [
        ...
        CustomButton(
            ...
            onPressed: () {
              ...
              _conditionRadioQuestionController.q8DemandController.clear();
              _conditionRadioQuestionController.q8EstimateDemand2YearsController
                  .clear();
              _conditionRadioQuestionController.q8EstimateDemand5YearsController
                  .clear();
            }),
      ],
    );
        ...
        Column(
          children: [
            ...
            CustomDropDown(
              ...
              list: sectorDropDownList,
              onChange: (value) {
                _conditionRadioQuestionController.q17SelectedSectorId(value.id);
              },
            ),
          ],
        ),
