...
class ConditionRadioQuestionController extends GetxController {
  ...
  TextEditingController q8OtherValueController = TextEditingController();
  ...
  TextEditingController q18OtherValueController = TextEditingController();
  ...
  disposeAllControllers() {
    ...
    q8OtherValueController.dispose();
    q18SkillLevelController.dispose();
    q18RequiredNumberController.dispose();
    q17TechController.dispose();
    q18OtherValueController.dispose();
  }

  clearQuestion8Fields() {
    q8DemandController.clear();
    q8EstimateDemand2YearsController.clear();
    q8EstimateDemand5YearsController.clear();
    q8OtherValueController.clear();
  }
  ...
  syncAnswersFromDatabase() {
    try {
      ...
      if (answerQuestion17 != null) {
        print(answerQuestion17.extraData);
        ...
        q17SelectedSectorId(answerQuestion17.extraData!["answers"]
  ...
  answerConditionalQuestion(
        ...
        question8AnswerList.add(
          {
            ...
            "other_value": element.otherValue
          },
        );
      }
      formData = {
    ...
    if (questionNumber == "17") {
      formData = {
        ...
        "technology": {
          "id": q17oldAnswerId,
          "sector_id": q17SelectedSectorId.value,
  ...
  List<OccupationModel> filterOccupationList(subId) {
    ...
    if (subId != null) {
      for (OccupationModel element
        ...
        if (element.sectorId == subId || element.sectorId == null) {
          list.add(element);
        }
      }
    } else {
  ...
  question8AnswerValidation() {
    if (q8RadioValue.value != 0 &&
      ...
      if (q8occupationName.value == "Others") {
        if (q8OtherValueController.text.isEmpty) {
          snackBar(_strings.failedTitle, "Please fill and select all fields!",
              error: true);
          return false;
        } else {
